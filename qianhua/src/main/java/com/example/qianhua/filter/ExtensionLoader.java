...
public class ExtensionLoader implements ApplicationContextAware {
    ...
    private static final String SERVICES_DIRECTORY = "META-INF/";
...
//        String url = "META-INF.spi/com.example.qianhua.filter.FilterChain";
//        ClassLoader classLoader = findClassLoader();
//        Enumeration<URL> urls = classLoader.getResources(url);
//        if (urls != null) {
//            while (urls.hasMoreElements()) {
//                URL resourcesURL = urls.nextElement();
//            }
...
//    }
     ...
     */
    private void loadClass(TreeMap<String, Object> extensionClasses, java.net.URL resourceURL, Class<?> clazz) throws IllegalStateException {
